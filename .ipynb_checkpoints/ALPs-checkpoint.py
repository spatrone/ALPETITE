...
import os
PETITE_home_dir='/Users/samuelpatrone/Desktop/Samuel/PhD/Papers/04 - SHIP ALPs/ALPETITE/PETITE_compatibility_version'
print("PETITE home directory:", PETITE_home_dir)
dictionary_dir = "/data_400GeV_default/"
print("VEGAS dictionary directory:", PETITE_home_dir+dictionary_dir)
...
class AxionShower:
    ...
    def plot_histo_flux(self, masses, folder_name='DATA_FINAL', w=5, h=4, legend_title_text=None,
    ...
    def compute_and_save_sensitivities(self, folder_name='DATA_FINAL', sens_folder_name='Sens', *,
